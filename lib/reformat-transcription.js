...
export default async function generateReformatedTranscription(filePath, minDuration) {
    ...
    fs.writeFileSync(path.dirname(filePath) + '/transcription-reformatted.json', JSON.stringify(transcriptionData, null, 2));
    console.log(`Przetworzona transkrypcja zapisana w ${path.dirname(filePath) + '/transcription-reformatted.json'}`);
}
